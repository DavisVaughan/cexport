...
- Let's be nice. In `inst/include/cexport_api.h` we create an API function with the same signature as our original function, look up the C callable once, and call the function.
